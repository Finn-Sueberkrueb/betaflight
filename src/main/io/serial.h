...
typedef enum {
    ...
    FUNCTION_TELEMETRY_MAVLINK_GS = FUNCTION_TELEMETRY_MAVLINK,  // 512 (alias)
    ...
    FUNCTION_TELEMETRY_MAVLINK_CC = (1 << 20), // 1048576
} serialPortFunction_e;

#define TELEMETRY_SHAREABLE_PORT_FUNCTIONS_MASK \
    (FUNCTION_TELEMETRY_FRSKY_HUB | FUNCTION_TELEMETRY_LTM | FUNCTION_TELEMETRY_MAVLINK_GS | FUNCTION_TELEMETRY_MAVLINK_CC)
